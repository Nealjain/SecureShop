    ...
    <div className="max-w-2xl mx-auto">
        ...
        {cart.map(item => (
          <div key={item.product_id} className="card flex items-center gap-3 p-4">
            ...
            <div className="flex-1 min-w-0">
              ...
              <p className="text-blue-600 font-semibold text-sm">Rs. {item.price.toLocaleString()}</p>
            </div>
            ...
            <p className="font-semibold text-sm w-20 text-right whitespace-nowrap">Rs. {(item.price * item.qty).toLocaleString()}</p>
      ...
      <div className="card">
        <div className="flex justify-between items-center mb-4">
          ...
          <span className="text-2xl font-bold text-blue-600 whitespace-nowrap">Rs. {total.toLocaleString()}</span>
        </div>
